...
demo:
	asciinema rec "demo.cast" --overwrite --rows 5 --cols 144 --title "TurboDL CLI Demo (https://github.com/henrique-coder/turbodl)" --command "echo \"$$ turbodl download -cs 650 https://github.com/henrique-coder/turbospeed-files/releases/download/turbospeed-files/200mb.bin /tmp\" && uv run turbodl download -cs 650 https://github.com/henrique-coder/turbospeed-files/releases/download/turbospeed-files/200mb.bin /tmp"
